...
<form action='' method='' id='formulario-denuncia' name='formulario-denuncia'>
    ...
    <div class="row" >
        <div class="col-sm-6">
            <button type='button' class='btn btn-defaulf' id='btnSairDenuncia' onclick="modalDenunciaFechar()" name="btnSairDenuncia"> Sair </button> 
        </div>
        <div class="col-sm-6">
        <button type='submit' class='btn btn-defaulf' id='btnEnviarDenuncia' name='btnEnviarDenuncia' > Enviar </button> 
        </div>
    </div>
</form>
</div>